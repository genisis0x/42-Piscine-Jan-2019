...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/29 13:58:36 by maparmar          #+#    #+#             */
/*   Updated: 2019/01/30 23:36:23 by maparmar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_instr		*ft_first_line(char *str)
{
	...
	if (check_v(str, a) == 1)
	{
		str2 = (char *)malloc(sizeof(*str2) * 100000);
        ptr = (t_instr *)malloc(sizeof(t_instr) * 100000);
		i = 0;
